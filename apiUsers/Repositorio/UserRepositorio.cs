...
using apiUsers.Repositorio.IRepositorio;
...
namespace apiUsers.Repositorio
{
    public class UserRepositorio : IUserRepositorio
    {
        ...
        public User GetUser(string identificationUser)
        {
            return _bd.User.FirstOrDefault(u => u.identificationUser == identificationUser);
        }
